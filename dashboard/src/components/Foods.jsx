      ...
      <div className="flex justify-between items-center mb-10">
        ...
        <div className="flex gap-3">
          <div className="relative text-base-100">
            <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4  text-base-content" />
            <input
              value={search}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-12 gap-y-28 mt-24">
        {filteredFoods.map((food) => (
          ...
          >
            ...
            {/* PRICE */}
            <p className="text-success font-bold mb-6">${food.price}</p>

            {/* ACTIONS */}
            <div className="flex gap-4 mt-auto">
              <button className="bg-success/10 text-success p-2 rounded-lg">
                <Eye size={18} />
              </button>

              <button
                onClick={() => openEdit(food)}
                className="bg-warning/10 text-warning p-2 rounded-lg"
              >
                <Pencil size={18} />
              </button>
              ...
              <button
                ...
                className="bg-error/10 text-error p-2 rounded-lg"
              >
                <Trash2 size={18} />
              </button>
            </div>
