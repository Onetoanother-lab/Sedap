...
const ROUTE_REGISTRY = [
  ...
  { path: '/wallet',          keywords: ['wallet', 'wallet', 'payment', 'transaction', 'finance', 'money'] },
];
      ...
      <div className="flex items-center space-x-4 ml-8">
        <div className="flex space-x-3">
          ...
          <IconButton count={counts.pendingTx} color="text-error" bgColor="bg-error/10" badgeColor="bg-error"
            title={`${counts.pendingTx} pending transaction${counts.pendingTx !== 1 ? 's' : ''}`} onClick={() => navigate('/wallet')}>
