...
export default function Login() {
  ...
  const handleEmailSubmit = async (e) => {
    e.preventDefault()
    setEmailError('')
    if (!form.email || !form.password) { setEmailError('Please fill in all fields'); return }
    ...
    <div className="auth-page">
      <div className="auth-left">
        <div className="auth-brand">
          ...
          <p>Your all-in-one point-of-sale system built for speed and clarity.</p>
          <div className="auth-left-rule" />
        </div>
        <div className="auth-left-deco">
          <div className="auth-left-deco-word">Sign</div>
          <div className="auth-left-deco-word accent">In.</div>
        </div>
      </div>
      ...
      <div className="auth-right">
        <div className="auth-form-box">
          ...
          <p className="auth-sub">Choose how you'd like to sign in</p>
