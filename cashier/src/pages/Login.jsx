...
export default function Login() {
  ...
  const handleEmail = async (e) => {
    ...
    setLoading(true)
    try { await login(form.email, form.password); navigate('/menu') }
  ...
  return (
    <div className="min-h-screen bg-base-300 flex">
      ...
      <div className="hidden lg:flex lg:w-5/12 bg-accent flex-col justify-between p-14">
        ...
        <div>
          <p className="text-neutral/70 text-sm font-medium mb-2 uppercase tracking-widest">Welcome back</p>
          <h1 className="text-neutral-content font-bold text-5xl leading-tight">Sign in<br/>to your<br/>account.</h1>
        </div>
        <p className="text-neutral/60 text-xs">Your all-in-one point-of-sale system.</p>
      </div>
          ...
          <div className="card-body gap-4">
            ...
            <div className="flex items-center gap-3 lg:hidden mb-2">
              <div className="bg-accent rounded-xl p-2.5">
                <GiKnifeFork className="text-neutral" size={20} />
              </div>
            ...
            <div className="mb-1">
              ...
              <p className="text-sm text-accent-content/50 mt-1">Sign in to continue</p>
            </div>
            ...
            <form onSubmit={handleEmail} className="flex flex-col gap-3" noValidate>
              ...
              <button type="submit" disabled={loading}
                className="btn bg-accent border-none text-neutral w-full mt-1">
